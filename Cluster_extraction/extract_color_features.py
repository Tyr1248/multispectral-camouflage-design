...
class ColorFeatureExtractor:
    ...
    def extract_colors(self, image_paths):
        """
        Extract dominant colors and their weights from images.

        Args:
            image_paths: a string or a list of strings

        Returns:
            A list where each element is [color list, weight list].
            color list: list of RGB tuples [(R,G,B), ...]
            weight list: proportion or representative weight of each color
                (list of floats)
        """
    ...
    def _extract_colors_single_stage_with_proportion(self, image_paths):
        ...
        Returns:
            A list of color lists, one per image
        """
        all_extracted = []
    ...
    def _extract_colors_two_stage_with_weight_transfer(self, image_paths):
        ...
        rgb_colors = self._lab_to_rgb_tuples(sorted_lab)
        return [[rgb_colors, sorted_weights.tolist()]]  # note the outer list
    ...
    def _calculate_and_sort_colors_by_proportion(self, lab_colors, pixels):
        """
        Compute color proportions and sort colors by proportion in descending order.
        ...
        Returns:
            List of RGB color tuples sorted by proportion
        """
        # Compute proportions
        proportions = self._calculate_color_proportions(lab_colors, pixels)
